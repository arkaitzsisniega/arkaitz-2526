...
tests = [
    ...
    ('cuantas sesiones lleva Pirata esta temporada',  'recuento_jugador'),
    ('participacion de Raya',  'recuento_jugador'),
]
results = []
for prompt, expected in tests:
    if mod._detectar_intent_lesiones(prompt): m = 'lesiones'
    elif mod._detectar_intent_recuento_jugador(prompt) is not None: m = 'recuento_jugador'
